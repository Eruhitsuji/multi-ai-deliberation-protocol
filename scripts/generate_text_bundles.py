...
def complete_protocol_index() -> str:
    lines = [
        ...
        "status: GENERATED_DISTRIBUTION_PRERELEASE_INDEX_ONLY",
        f"source_branch: {SOURCE_BRANCH}",
        f"release_tag: {RELEASE_TAG}",
        "generator: scripts/generate_text_bundles.py",
        "limitations:",
        "- This committed artifact is a reproducible source index, not the self-contained upload artifact.",
        "- The self-contained artifact is generated by CI as complete-protocol-bundle.full.txt.",
        "- This index describes a published alpha prerelease and does not claim production stability.",
        "included_sources:",
    ]
...
def self_contained_bundle(records: list[dict[str, Any]], source_commit: str) -> str:
    ...
    lines = [
        "BEGIN_MADP_BUNDLE_METADATA",
        f"protocol_version: {VERSION}",
        "status: GENERATED_SELF_CONTAINED_PRERELEASE_ARTIFACT",
        f"source_branch: {SOURCE_BRANCH}",
        f"release_tag: {RELEASE_TAG}",
        ...
        "limitations:",
        "- This is an alpha prerelease artifact and may change incompatibly in later prereleases.",
